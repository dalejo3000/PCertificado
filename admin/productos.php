...
<head>
  ...
  <title>Asignar certificado</title>
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">Asignar certificado</h1>
            </div><!-- /.col -->
            <div class="col-sm-6 text-right">

               <!--
               <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">
                <i class="fa fa-plus"></i> Insertar certificado
              -->
              </button>
            </div><!-- /.col -->
          </div><!-- /.row -->
      ...
      <!-- /.content-header -->
      <form action="./ingresarreg.php" method="GET">
        <div class="p-3 p-lg-5 border">
            <h3 class="h3 mb-3 text-black">Nuevo registro de estudiante</h2>
              <div class="col-6 col-md-4 order-2 order-md-1 site-search-icon text-left">
                  <span class="icon icon-search2"></span>
                  <input type="text" class="form-control border-0" placeholder="Ingrese cédula del usuario" name="texto">
                  <h6 class="h6 mb-1 text-blue">Presione la tecla enter para ingresar nueva información</h6>
              </div>
        </div>
      </form>
      <!-- Main content -->
        ...
        <div class="modal-content">
          <form action="../php/insertarproducto.php" method="POST" enctype="multipart/form-data">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">Insertar certificado</h5>
            ...
            <div class="modal-body">
              <form action="./ingresarreg.php" method="GET">
                <div class="p-3 p-lg-2 border">
                      <div class="form-group order-2 order-md-1 site-search-icon text-left">
                          <span class="icon icon-search2"></span>
                          <input type="text" class="form-group border-1" placeholder="Ingrese cédula del usuario" name="texto">
                          <h6 class="h6 mb-1 text-blue">Presione la tecla enter para ingresar nueva información</h6>
                      </div>
                </div>
              </form>
                     ...
                     <?php
                      $res= $conexion->query("select * from usuario");
                        while($f=mysqli_fetch_array($res)){
                          echo '<option value="'.$f['cedula'].'" >'.$f['cedula'].'</option>';

    ...
    <div id="container">
      ...
      <form action="./productos.php" method="post">
        <div class="p-3 p-lg-5 border">
            ...
            <form id="details" target="_blank" action="../php/insertarproducto.php" method="POST" enctype="multipart/form-data">
                <div class="p-3 p-lg-5 border">
                ...
                <div class="form-group">
                  <!--Consulta 1-->
                                    ...
                                    ?>
                                      ...
                                      <div class="col-md-6">
                                        ...
                                        <input id="nombre" name="nombre" class="textField" placeholder="Nombres y Apellidos" readonly
                                          value="<?php echo $fila['nombre']; ?>" required>
                                      </div>

                                      <div class="col-md-6">
                                        <label>Cédula del Estudiante:</label></br>
                                        <input id="cedula" name="cedula" class="textField" placeholder="CI" readonly
                  ...
                  <div class="form-group">
                    <?php
                      $res= $conexion->query("select * from cursos")or die($conexion -> error);
                        if(mysqli_num_rows($resultado) > 0){
                    ?>
                  ...
                  <!--Consulta 3-->
                      ...
                      <div class="content-header">
                        <div class="container-fluid">
                          <div class="row mb-2">
                            <div class="col-sm-6 text-right">
                                <input type="submit" value="Crear Certificados" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">
                                <i class="fa">
                            </div>
                          </div><!-- /.row -->
                        </div><!-- /.container-fluid -->

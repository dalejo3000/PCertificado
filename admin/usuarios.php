<?php
  ...
  $resultado = $conexion ->query("
    select * from usuario where nivel='admin'
  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6 text-right">
             <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">
              <i class="fa fa-plus"></i> Insertar Administrador
            </button>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      <div class="container-fluid">
          ...
          <?php  }?>
          <?php
            if(isset($_GET['successdup'])){
          ?>
            <div class="alert alert-warning" role="alert">
              Este usuario o cédula ya existe, prueba con otra información.
            </div>
          <?php  }?>
          <?php
          ...
          <table class="table">
            <thead>
              <tr>
                ...
                <!--<th>password</th>-->
                <th>Nivel</th>
                <th>Cedula<span class="text-danger">*</span></th>
                <th>Fecha</th>
                   ...
                   <tr>
                      ...
                      <td>
                        <button class="btn btn-primary btn-small btnEditar"
                          ...
                          data-curso="<?php echo $f['fecha_creacion']; ?>"
        ...
        <?php /* include("./layouts/header.php"); */?>
          <form action="../tyclientes.php" method="POST" enctype="multipart/form-data">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Insertar Administrador</h5>
          ...
          <div class="modal-body">
            <div class="col-md-20 mb-5 mb-md-0">
              <div class="p-3 p-lg-5 border">
                  <!--<h2 class="h3 mb-3 text-black">Crear Administrador</h2>-->
                ...
                <div class="form-group row">
                  <label for="c_account_password" class="text-black">Password<span class="text-danger">!</label>
                ...
                <div class="form-group">
                  <button class="btn btn-primary btn-lg py-3 btn-block" type="submit">Crear Administrador</button>
                </div>
              </div>
            </div>
    ...
    <div class="modal fade" id="modalEliminar" tabindex="-1" role="dialog" aria-labelledby="modalEliminarLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
              <h5 class="modal-title" id="modalEliminarLabel">Eliminar Administrador</h5>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <form action="../php/editarcliente.php" method="POST" enctype="multipart/form-data">
          <div class="modal-header">
            <h5 class="modal-title" id="modalEditar">Editar Administrador</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <div class="modal-body">
              ...
              <div class="form-group">
                  <label for="nombreEdit">Nombre<span class="text-danger">*</span></label>
                  <input type="text" name="nombre" placeholder="Nombres y Apellidos" id="nombreEdit" class="form-control" required>
              </div>
              <div class="form-group">
                  <label for="telefonoedit">Telefono<span class="text-danger">*</span></label>
              ...
              <div class="form-group">
                  <label for="cedulaEdit">Cédula<span class="text-danger">*</span></label>
                  <input type="text" name="cedula" placeholder="CI" id="cedulaEdit" class="form-control" required>
              </div>
              <div class="form-group">
                  <label for="fechaEdit">Fecha de Nacimiento<span class="text-danger">*</span></label>

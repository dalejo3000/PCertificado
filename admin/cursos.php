      ...
      <div class="modal-content">
        <form action="../php/insertarcurso.php" method="POST" enctype="multipart/form-data">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Insertar Curso</h5>
          ...
          <div class="modal-body">
              ...
              <div class="form-group">
                  <label for="duracion">Duración (hrs.)<span class="text-danger">*</span></label>
       ...
       <div class="modal-content">
         <form action="../php/editarcurso.php" method="POST" enctype="multipart/form-data">
           ...
           <div class="modal-body">
               ...
               <div class="form-group">
                   <label for="descripcionEdit">Descripcion<span class="text-danger">*</span></label>
                   <input type="text" name="descripcion" placeholder="descripcion" id="descripcionEdit" class="form-control" required>
               </div>
               <div class="form-group">
                   <label for="duracionEdit">Duración (hrs.)<span class="text-danger">*</span></label>
                   <input type="number" min="0" name="duracion" placeholder="duracion" id="duracionEdit" class="form-control" required>
               </div>

               <div class="form-group">
                   <label for="fecha_inicioEdit">Fecha de inicio<span class="text-danger">*</span></label>

...
<head>
  ...
  <title>Generador certificado (PDF)</title>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Generador certificado (PDF)</h1>
          </div><!-- /.col -->
                  ...
                  <h3 class="h3 mb-3 text-black">Búsqueda de estudiante</h2>
                    <div class="col-6 col-md-4 order-2 order-md-1 site-search-icon text-left">
                      <form action="./busqueda.php" class="site-block-top-search" method="GET">
                        ...
                        <h6 class="h6 mb-3 text-blue">Presione la tecla enter para generar la búsqueda</h6>
                      </form>
                    </div>
              </div>
            </form>

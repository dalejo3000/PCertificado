...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 01-04-2021 a las 19:17:21
...
CREATE TABLE `cursos` (
  ...
  `imagen` varchar(400) CHARACTER SET utf8 NOT NULL,
  `fecha_creacion` date NOT NULL,
  `usuario_creacion` varchar(128) CHARACTER SET utf8 NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(1, 'Matemáticas', 'Curso de Matemáticas', 10, '2021-03-10', '', '2021-03-26', ''),
...
(14, 'Curso del MIL y Chivo', 'La que se abrió con el chivo, la competencia del Saul', 30, '2021-03-15', '', '2021-03-30', '');
...
CREATE TABLE `usuario` (
  ...
  `cedula` char(10) CHARACTER SET utf8 NOT NULL,
  `fecha` date NOT NULL,
  `curso` varchar(123) CHARACTER SET utf8 NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
